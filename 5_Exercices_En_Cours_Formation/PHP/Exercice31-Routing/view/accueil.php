 ...
 <h3>Inscription</h3>
    ...
    <h3>Connexion</h3>
    <form action="" method="post">
        <input type="text" name="login_users_connexion" placeholder="entrez votre identifiant">
        <input type="text" name="mdp_users_connexion" placeholder="entrez votre mot de passe">
